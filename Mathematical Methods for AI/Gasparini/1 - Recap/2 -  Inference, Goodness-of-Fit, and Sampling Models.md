...
> ⚠️ **N.B.:** This asymptotic interval is an approximation. For such a small sample size ($n = 5$), its coverage probability is too low. In practice, better exact procedures (e.g., the **Clopper-Pearson** interval) should be used.
...
Pearson proved that if $H_0$ is true, the test statistic asymptotically follows a Chi-square distribution with $D - 1$ degrees of freedom:
...
## Summary of Discrete Random Vectors
